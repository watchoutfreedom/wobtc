<div class="pricing">
	...
	<div class="pricing__box">
		...
		<li><?php get_template_part('icons/check'); ?>Debates del sábado y domingo</li>
			<li><?php get_template_part('icons/check'); ?>Acceso a Fanzone</li>
			<li><?php get_template_part('icons/check'); ?>Cocktail del sábado con ponentes! AfterWOB (domingo 15-20 hs)</li>
	...
	<div class="pricing__box">
		<div class="pricing__card">
			...
			<div class="pricing__day">3 días (viernes, sábado y domigo)</div>
		</div>
		<ul class="pricing__list">
		<li><?php get_template_part('icons/check'); ?>Acceso a Fanzone</li>
			<li><?php get_template_part('icons/check'); ?>Cocktail del sábado con ponentes! AfterWOB (domingo 15-20 hs)</li>
			...
			<li><?php get_template_part('icons/check'); ?>Acceso a Talleres</li>
			<li><?php get_template_part('icons/check'); ?>Acceso al Cocktail del viernes con Ponentes</li>
			<li><?php get_template_part('icons/check'); ?>Comidas en la Fanzone los días sábado y dDomingo</li>
		</ul>
	</div>
	<!-- talleres -->
</div>